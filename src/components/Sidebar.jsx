...
const ADMIN_NAV = [
  {
    ...
    icon: <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
  },
  {
    label: 'Orders', to: '/orders', end: false,
    icon: <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>
  },
  {
    label: 'Doors', to: '/admin/doors', end: false,
    icon: <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="1" width="18" height="22" rx="1"/><circle cx="17" cy="12" r="1" fill="currentColor"/></svg>
  },
  {
    label: 'Windows', to: '/admin/windows', end: false,
    icon: <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="3" width="20" height="18" rx="1"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="12" y1="3" x2="12" y2="21"/></svg>
  },
  {
    label: 'Reports', to: '/reports', end: false,
    icon: <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
  },
  {
...
const CUSTOMER_NAV = [
  ...
  },
  {
    ...
    icon: <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
  },
  {
...
export default function Sidebar({ role }) {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex flex-col fixed left-0 top-0 h-screen w-[260px] bg-[#111111] border-r border-white/[0.05] z-30">
        ...
        <div className="px-3 py-4 border-t border-white/[0.05]">
          <button onClick={handleLogout}
            ...
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="flex-shrink-0">
      ...
      {/* ── MOBILE BOTTOM NAV (no topbar at all) ────── */}
      <nav
        className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-[#111111] border-t border-white/[0.08]"
        ...
        <div className="flex items-stretch h-[60px]">
          ...
          {links.map(link => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex-1 flex flex-col items-center justify-center gap-[3px] relative transition-all ${
                  isActive ? 'text-[#D4A04A]' : 'text-white/30 active:text-white/60'
                }`
              }>
              {({ isActive }) => (
                <>
                  {isActive && (
                    <span className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-[2px] bg-[#D4A04A] rounded-b-full" />
                  )}
                  <span className={isActive ? 'text-[#D4A04A]' : 'text-white/30'}>
                    {link.icon}
                  </span>
          ...
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center gap-[3px] text-white/25 active:text-red-400 transition-all">
            <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="text-white/30">
